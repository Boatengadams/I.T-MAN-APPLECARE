    ...
    <>
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-gray-400 text-center lg:text-left mt-4 text-lg">
              Buy & Sell premium Apple Watches - Select size
            </p>
          </div>
          <div className="h-40 lg:h-60 rounded-xl overflow-hidden shadow-xl">
            <video
              ...
              poster="/images/watchimages/series%209.jpg"
            >
      ...
      {selectedProduct ? (
        <div className="container mx-auto px-6">
          <button
            onClick={() => { setSelectedProduct(null); setSelectedSize(""); setShow3D(false); }}
            className="mb-6 text-amber-600 hover:text-amber-500 flex items-center gap-2"
          >
            ← Back to all Apple Watches
          </button>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-gray-400 mb-4 text-sm">
                Premium quality Apple Watch available for sale. Each device is thoroughly inspected and certified.
              </p>
