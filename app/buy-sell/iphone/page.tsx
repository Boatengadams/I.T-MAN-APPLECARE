  ...
  return (
    <div className="px-4 py-4">
      ...
      {product.colors && product.colors.length > 0 && (
        <div className="mb-4">
          <p className="text-gray-400 text-sm mb-2 text-center">Select Color</p>
          <div className="flex justify-center gap-3">
            {product.colors.map((color) => (
              <button key={color} onClick={() => setSelectedColor(color)}
                className={`w-10 h-10 rounded-full border-2 ${selectedColor === color ? "border-amber-500 scale-110" : "border-white/20 hover:border-white/40"}`}
