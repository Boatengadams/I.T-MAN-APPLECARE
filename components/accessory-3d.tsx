    ...
    <div className="w-full h-[400px] md:h-[500px] relative">
      <Canvas camera={{ position: [0, 0, 4], fov: 40 }}>
        ...
        <Suspense fallback={null}>
          <AccessoryModel modelPath={modelPath} />
