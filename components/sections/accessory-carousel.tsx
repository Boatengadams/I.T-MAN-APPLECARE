...
function generateCarouselItems(items: typeof accessories, count: number): typeof accessories {
  const result: typeof accessories = [];
...
export function AccessoryCarousel() {
  ...
  const [carouselItems, setCarouselItems] = useState<typeof accessories>([]);

  useEffect(() => {
    setCarouselItems(generateCarouselItems(accessories, 6));
  }, []);
